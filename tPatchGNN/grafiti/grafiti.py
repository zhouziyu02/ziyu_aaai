...
class GraFITi(nn.Module):
    ...
    def __init__(
        self, args, input_dim=41, attn_head=4, latent_dim=128, n_layers=2, device="cuda"
    ):
        super().__init__()
        self.dim = args.ndim  # input dimensions
        self.attn_head = args.nhead  # no. of attention heads
